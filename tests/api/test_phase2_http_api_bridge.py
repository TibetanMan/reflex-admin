...
def test_admin_account_api_client_calls_http_route(monkeypatch):
    module = importlib.import_module("services.admin_account_api")
    captured: dict[str, object] = {}
    ...
    def _fake_request_json(method: str, path: str, payload: dict | None = None):
        ...
        captured["path"] = path
        captured["payload"] = payload
        return {"username": "new_admin", "role": "agent"}

    monkeypatch.setattr(module, "request_json", _fake_request_json)
    row = module.create_admin_account(
